---
title: "Análise Estatística da Old Town Road Ltda."
header-includes:
  - \authors{Lizandra}
...
"\begin{quadro}[H]
	\setlength{	\tabcolsep}{9pt}
	\renewcommand{	\arraystretch}{1.20}
	\caption{Medidas resumo da idade - Banco Careca}
	\centering
	\begin{adjustbox}{max width=\textwidth}
	\begin{tabular} { | l |
			S[table-format = 1.2]
...
\end{quadro}
	...
	\setlength{	\tabcolsep}{9pt}
	\renewcommand{	\arraystretch}{1.20}
	\caption{Medidas resumo da idade - Vendinha Rápida}
	\centering
	\begin{adjustbox}{max width=\textwidth}
	\begin{tabular} { | l |
			S[table-format = 1.2]
...
\end{quadro}
	...
	\setlength{	\tabcolsep}{9pt}
	\renewcommand{	\arraystretch}{1.20}
	\caption{Medidas resumo da idade - Saloon}
	\centering
	\begin{adjustbox}{max width=\textwidth}
	\begin{tabular} { | l |
			S[table-format = 2.2]
...
\end{quadro}
	...
	\setlength{	\tabcolsep}{9pt}
	\renewcommand{	\arraystretch}{1.20}
	\caption{Medidas resumo da idade - Ferraria Seca}
	\centering
	\begin{adjustbox}{max width=\textwidth}
	\begin{tabular} { | l |
			S[table-format = 2.2]
